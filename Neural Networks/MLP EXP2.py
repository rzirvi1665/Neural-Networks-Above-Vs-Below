...
for finalWeights in model.trainable_variables:
  ...
  if finalWeights.shape==(256, 2):
    heatMapMLPOutput(finalWeights, initialWeights, 2)
    break
...
showIncorrect(testingData, testingLabels, predictions, numTest, 5)

showCorrect(testingData, testingLabels, predictions, numTest, 5)
